...
We started by forking the GitHub repositories for poole and Hyde (optional formatting layer) and changing settings to generate our own webpage. The rest of the session looking at layout options; pages and posts, and working out how add <a href="http://en.wikipedia.org/wiki/IFrame>iframes</a> to emebed D3js and TimelineJS visualistions.
