...
The Julia web interface is Jupyter, the same Notebook web interface that is used for Python. Researchers wishing to spend more time working with the Notebook for Python will probably find this useful.
